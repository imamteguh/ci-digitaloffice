...
class User extends CI_Controller
{
	...
	function index($akses=null)
	{
		...
		if($this->form_validation->run()===TRUE) {
			...
			$member_jabatan_id = $this->input->post('member_jabatan_id');
			...
			if($user_id=='') {
				...
				$inpMember = array(
						...
						'member_tlp'=>$member_tlp,'member_foto'=>$member_foto,'member_dinas_id'=>$member_jabatan_id
						);
				...
				$inpMember = array(
						'member_nip'=>$member_nip,'member_nama'=>$member_nama,'member_email'=>$member_email,
						'member_tlp'=>$member_tlp,'member_dinas_id'=>$member_jabatan_id
						);
