<div class="col-md-12">
    ...
    <div class="box primary">
        <header>
            ...
            <h5>Data Member</h5>
            <div class="toolbar">
                <button class="btn btn-success btn-sm btn-rect" data-toggle="collapse" data-target="#div3"><i class="icon-chevron-down"></i></button>
            </div>
        </header>
                ...
                <table class="table table-striped table-hover" id="dataTables-example">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                            <a href="<?php echo site_url('user/index/edit/'.$rows->member_nip)?>" class="btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icon-pencil icon-white"></i></a>
                            <a href="<?php echo site_url('user/hapus/'.$rows->member_nip)?>" class="btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="icon-remove icon-white"></i></a>
                            </td>
                        </tr>
                    <?php
                    $no++;
...
<div class="col-md-6">
    <div class="box primary">
        <header>
            ...
            <div class="toolbar">
                <button class="btn btn-success btn-sm btn-rect" data-toggle="collapse" data-target="#div1"><i class="icon-chevron-down"></i></button>
            </div>
        </header>
        ...
        <form method="post" action="<?php echo site_url('user')?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="member_jabatan_id">
                    <option>- Pilih Instansi -</option>
                    <?php
                    foreach ($jabatan as $rows) {
                        echo '<option value="'.$rows->dinas_id.'" '; if($getData[0]['member_dinas_id']==$rows->dinas_id){ echo "selected"; } echo '>'.$rows->dinas_nama.'</option>';
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="form-group">
                <label>Passowrd<sup class="text-danger">*</sup>
            ...
            <div class="form-group">
                ...
                <?php elseif($getData[0]['status']=='superadmin'):?>
